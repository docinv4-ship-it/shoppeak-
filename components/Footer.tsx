    ...
    <footer className="bg-gray-900 text-gray-300 mt-12">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            <Link href="/" className="flex items-center gap-0.5 mb-3">
              ...
              <span className="bg-orange-500 text-white font-black text-xl px-1 rounded">
                Peak
              </span>
            </Link>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              ...
              <Link href="/affiliate-disclosure" className="text-orange-400 hover:underline">
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-xs text-gray-500">© 2026 ShopPeak. All rights reserved.</p>
