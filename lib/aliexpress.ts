...
// 🎯 EXACT CATEGORY TO ID ENGINE: Jo aapki sabhi categories ko proper products ke sath bind karta hai
...
// ─── MAIN SEARCH PRODUCTS LOGIC (Fixing category distribution & global mix) ───
export async function searchProducts(
  ...
  // 🔄 Check if user clicked any Category Card/Filter
  ...
  // 💎 MATRIX BLENDING LAYER: Jab pure browse page par sab mixed chahye bina kisi specific filter ke
  ...
  if (isAllProductsRequest) {
    ...
    try {
      ...
      console.error("Blended matrix loading fallback logic active", err);
    }
